...
namespace RPG_game
{
    internal class Player : Character
    {
        ...
        private void ThrowDirt(Character opponent)
        {
        ...
        private void ThrowRasengen(Character opponent)
        {
        ...
        private void UseShadowClone(Character opponent)
        {
        ...
        public override void Fight(Character
opponent)
        {
